...
do
    case $1 in
        --kubeconfig-list) __KUBECONFIG_LIST=$2; shift 2;;
        --kubecontext-list) __KUBECONTEXT_LIST=$2; shift 2;;
        --debug) __DEBUG=1; shift 1;;
        -- ) shift; break ;;
        * ) break ;;
    esac
done
...
do
    ...
    do
        ...
        log_info $(basename $j) => $(basename $i) : echo $?
    done
done
exit 0
# 开始执行检测
